...
contract StakedAuxilium is ERC20Permit, Ownable {
    ...
    constructor() ERC20("StakedAuxilium", "sAUXL", 9) ERC20Permit() {
    ...
    /**
        @notice increases StakedAuxilium supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess StakedAuxilium
