...
interface DistributorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "nextEpochAuxl()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nextEpochAuxl",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Distributor extends BaseContract {
  ...
  functions: {
    ...
    nextEpochAuxl(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    nextEpochAuxl(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nextEpochAuxl(overrides?: CallOverrides): Promise<PopulatedTransaction>;
