...
interface AuxlTreasuryInterface extends ethers.utils.Interface {
  functions: {
    "AUXLries()": FunctionFragment;
    ...
    "repayDebtWithAuxl(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "AUXLries", values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: "repayDebtWithAuxl",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "AUXLries", data: BytesLike): Result;
...
export class AuxlTreasury extends BaseContract {
  ...
  interface: AuxlTreasuryInterface;

  functions: {
    AUXLries(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    AUXLries(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    AUXLries(overrides?: CallOverrides): Promise<PopulatedTransaction>;
