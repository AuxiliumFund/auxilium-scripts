...
interface AuxlBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class AuxlBondingCalculator extends BaseContract {
  ...
  interface: AuxlBondingCalculatorInterface;
