...
interface AuxlBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "InitTerms(tuple)": EventFragment;
    "LogRecoverLostToken(address,uint256)": EventFragment;
    "LogSetAdjustment(tuple)": EventFragment;
    "LogSetStaking(address,bool)": EventFragment;
    "LogSetTerms(uint8,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "InitTerms"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "LogRecoverLostToken"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "LogSetAdjustment"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "LogSetStaking"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "LogSetTerms"): EventFragment;
...
export type InitTermsEvent = TypedEvent<
  [
    ...
    terms: [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, number] & {
      controlVariable: BigNumber;
      minimumPrice: BigNumber;
      maxPayout: BigNumber;
      fee: BigNumber;
...
export type LogRecoverLostTokenEvent = TypedEvent<
  [string, BigNumber] & { tokenToRecover: string; amount: BigNumber }
>;

export type LogSetAdjustmentEvent = TypedEvent<
  [
    ...
    adjust: [boolean, BigNumber, BigNumber, number, number] & {
      add: boolean;
      rate: BigNumber;
      target: BigNumber;
      buffer: number;
...
export type LogSetStakingEvent = TypedEvent<
  [string, boolean] & { stakingContract: string; isHelper: boolean }
>;

export type LogSetTermsEvent = TypedEvent<
  [number, BigNumber] & { param: number; value: BigNumber }
>;
...
export class AuxlBondDepository extends BaseContract {
  ...
  interface: AuxlBondDepositoryInterface;
  ...
  filters: {
    ...
    "LogRecoverLostToken(address,uint256)"(
      tokenToRecover?: string | null,
      amount?: null
    ): TypedEventFilter<
      [string, BigNumber],
      { tokenToRecover: string; amount: BigNumber }
    >;
    ...
    "LogSetStaking(address,bool)"(
      stakingContract?: string | null,
      isHelper?: null
    ): TypedEventFilter<
      [string, boolean],
      { stakingContract: string; isHelper: boolean }
    >;
    ...
    "LogSetTerms(uint8,uint256)"(
      param?: null,
      value?: null
    ): TypedEventFilter<
      [number, BigNumber],
      { param: number; value: BigNumber }
    >;
