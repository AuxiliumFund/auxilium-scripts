...
interface WAUXLInterface extends ethers.utils.Interface {
  functions: {
    "AUXL()": FunctionFragment;
    "AUXLTowAUXL(uint256)": FunctionFragment;
...
export class WAUXL extends BaseContract {
  ...
  filters: {
    ...
    "UnWrap(address,uint256,uint256)"(
      ...
      [string, BigNumber, BigNumber],
      { recipient: string; amountWmemo: BigNumber; amountSAuxl: BigNumber }
    >;
    ...
    "Wrap(address,uint256,uint256)"(
      ...
      [string, BigNumber, BigNumber],
      { recipient: string; amountSAuxl: BigNumber; amountWmemo: BigNumber }
    >;
